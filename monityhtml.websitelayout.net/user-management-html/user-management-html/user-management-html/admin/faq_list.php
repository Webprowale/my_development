...
$sql_count = "SELECT COUNT(id) AS id_count FROM faq"; // Replace 'faq' with your table name
                ...
                <div class="col-lg-7">
                    <div class="single_user_pil d-flex align-items-center justify-content-between">
                        <div class="user_pils_thumb d-flex align-items-center">
                            ...
                            <span class="f_s_14 f_w_400 text_color_11"><?php echo $row['heading']; ?></span>
                        </div>
                        <div class="user_info">
                            <?php echo $row['fullWord']; ?>
                        </div>
