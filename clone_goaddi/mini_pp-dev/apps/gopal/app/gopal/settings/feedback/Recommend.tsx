    ...
    <>
      <section className="grid grid-cols-[2fr_1fr]">
        <div className="p-5 pb-20 border-r border-r-[#E4E7EC] flex flex-col">
          <p className=" mt-2 text-sm leading-[24px]">Help us Improve</p>
          ...
          <FeedbackTextarea
            className="h-[217px] rounded-[4px] border-[#98A2B3] border-[1px] placeholder:text-sm focus:border-[#98A2B3] focus:border-[1px] mb-[28px] text-sm p-3 resize-none focus-visible:outline-primary600"
        ...
        <div className="border-[#E4E7EC] p-5">
          <div className="flex flex-col gap-[16px]">
            <label
              className="font-[400] text-sm leading-[24px] mt-2"
