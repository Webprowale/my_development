          ...
          <div className="bg-primary700 py-4 px-4 mx-5 mt-6 rounded-lg">
            ...
            <div className="">
              <div className="inline-flex gap-1 items-center ">
                ...
                />
                <div className="text-sm text-white">Flight</div>
              </div>
              {/* Flights Details */}
              <div className="">
                <ul className="flex flex-col gap-5 mt-3">
                  {FLIGHTS_DETAILS.map((flight, index) => {
                    const { discount, tax, ticket, traveller } = flight;
                    return (
                      <li
                        key={index}
                      ...
                      >
                        <div className="flex justify-between">
                          ...
                          <div className="text-[13px]">{naira(ticket)}</div>
                        </div>
                        <div className="flex justify-between">
                          <div className="text-[13px] text-gray-100">
                            Taxes and Fees
            ...
            <div className="pb-3">
              <div className="inline-flex gap-1 items-center ">
                <RoadHorizon weight="fill" size={20} className="text-white" />
                <div className="text-sm text-white">Activities</div>
              </div>
              {/* Activities Details */}
              <div className="">
                <ul className="flex flex-col gap-5 mt-3">
                  {ACTIVITIES_DETAILS.map((flight, index) => {
                    const { discount, tax, ticket, traveller } = flight;
                    return (
                      <li
                        key={index}
