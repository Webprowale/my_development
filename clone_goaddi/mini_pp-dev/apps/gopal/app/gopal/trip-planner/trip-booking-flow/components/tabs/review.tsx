...
import SplitPay from "../payments/split";
...
const Review = (props: Props) => {
  ...
  return (
    <>
      <div>
        <div className="my-5">
          <h2 className="font-semibold "> Review and Confirmation</h2>
        ...
        <div className="w-full mt-4 mb-5 p-4 border border-slate-200 rounded-sm">
          <div className="flex justify-between items-center mb-3">
            <h3 className="text-base font-semibold">Hotel Information</h3>
            <div className="text-sm text-primary600">Hotel details</div>
          </div>
          <HotelInformation
            hotelName=" Rivera Resort, Lekki"
            hotelAddress="18, Kenneth Agbakuru Street, Off Access Bank Admiralty Way, Lekki
            Phase1"
            checkIn="20-40-2024"
            checkOut="29-40-2024"
        ...
        <div className="w-full mt-4 mb-5 p-4 border border-slate-200 rounded-sm">
          <div className="flex justify-between items-center mb-3">
            <h3 className="text-base font-semibold">Activity Information</h3>
            <div className="text-sm text-primary600">Activity details</div>
          </div>
          <ActivityInformation
            activityName="The Museum of Modern Art"
            activityAddress="Works from Van Gogh to Warhol & beyond plus a sculpture garden, 2 cafes & The modern restaurant"
            date="20-40-2024"
            time="11:30am"
            day="1"
            guests="1 Adult, 2 Children"
