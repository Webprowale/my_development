...
import BookTitle from "./components/title";
            ...
            <div className="mt-4">
              <div className="flex border border-slate-200 rounded-md w-fit">
                {tripbooking?.map((booking) => {
                  ...
                  return (
                    <Link
                      href={`/gopal/trip-planner/trip-booking-flow?step=${href}`}
                      className="p-3"
                    >
                      <div className="flex items-center gap-2">
                        {active ? (
                          ...
                          <div className="text-xs rounded-full tex`t-[9px] border-gray-600 border w-5 h-5 flex justify-center items-center">
                            {id}
                          </div>
                        )}
                        <p
