  ...
  return (
    <div ref={targetRef} className="">
      <div className="max-w-[630px] mx-auto">
        ...
        Great news, Your booking for your <strong>Riviera Resort, Lekki</strong> is confirmed!  We're processing everything now, and you'll receive a confirmation email shortly containing all the details. 
        </p>

        {/* <div className=" w-full flex items-center justify-between  gap-4 mb-4 mt-6">
          {data.map((card) => {
            const { code, title, type } = card;
            return <CodeCard code={code} title={title} type={type} />;
          })}
        </div> */}
        ...
        <div className="inline-flex gap-2 items-center text-sm leading-7 font-medium text-black mb-2">
          <Buildings className="text-black" size={18} weight="bold" />
          Hotels
        </div>
        <Hotels
          bookingId="L98SZAY"
          paymentRef="123456742URY7"
          price="NGN 100,000.00"
          hotelName="Rivera Resort"
          hotelAddress="18, Kenneth Agbakuru Street, Off Access Bank Admiralty Way, Lekki Phase 1"
          checkIn="20-04-2024"
          checkOut="29-04-2024"
          room="1"
          nights="10"
