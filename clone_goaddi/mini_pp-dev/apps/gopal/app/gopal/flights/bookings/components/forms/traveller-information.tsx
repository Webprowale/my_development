...
export const TravellerInformation = ({
  // key,
  travellerDetails,
  typeOfCardColorClass='bg-secondary100 text-secondary800'
}: {
  travellerDetails: Traveler;
  typeOfCardColorClass?:string
    ...
    >
      <div className="flex justify-between">
        <div className="flex gap-3 items-center">
          ...
          <div className={`text-xs capitalize  p-1.5 ${typeOfCardColorClass}`}>
      ...
      <div className="my-4">
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className=" w-full">
            <div className="flex flex-wrap gap-7 items-center w-full mb-5">
              <FormField
                control={form.control}
                name="title"
                render={({ field }) => (
                  <FormItem className="space-y-0 w-[100%] md:w-[20%]">
            ...
            <div className="flex flex-wrap md:flex-nowrap gap-7 items-center w-full mb-5">
              <FormField
                control={form.control}
                name="gender"
                render={({ field }) => (
                  <FormItem className="space-y-0  w-[100%] md:w-[30%]">
                    <FormLabel className="text-sm font-normal relative">
                      <span className="text-red-600 absolute -top-px -right-1.5 text-xs">
                        *
                      </span>
            ...
            <div className="flex flex-wrap md:flex-nowrap gap-7 w-full mb-5">
              <FormField
                control={form.control}
                name="phone"
                render={({ field }) => (
                  <FormItem className="mt-px space-y-0 w-[100%] md:w-[40%]">
                    <FormControl>
              ...
              <FormField
                ...
                name="dob"
                render={({ field }) => (
                  <FormItem className="flex flex-col z-10 w-[100%] md:w-[40%]">
              ...
              <FormField
                ...
                name="idType"
                render={({ field }) => (
                  <FormItem className="space-y-0 w-[100%] md:w-[25%]">
                    <FormLabel className="text-sm font-normal relative">
                      <span className="text-red-600 absolute -top-px -right-1.5 text-xs">
                        *
                      </span>
            ...
            <div
             className="flex flex-wrap md:flex-nowrap gap-7 w-full mb-5"
            >
            <FormField
                control={form.control}
                name="idNumber"
