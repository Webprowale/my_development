      ...
      <div>
        ...
        <div className="w-full mt-4 mb-5 p-4 border border-slate-200 rounded-sm">
          <div className="flex justify-between items-center mb-3">
            ...
            <div className="text-sm text-primary600">See details</div>
          </div>
          <VacationPackageCardReview
            hotelName=" Rivera Resort, Lekki"
            hotelAddress="Bangkok, Thailand"
            checkIn="20-40-2024"
            checkOut="29-40-2024"
...
const VacationPackageCardReview = ({
  hotelName,
  hotelAddress,
  checkIn,
  checkOut,
      ...
      <div className="flex gap-3 items-start">
        ...
        <div className="flex flex-col gap-1">
          ...
          <div className="flex items-center gap-3 flex-wrap text-sm mt-1">
            {/* <div className="inline-flex gap-2 items-center">
              <Bed weight="fill" size={18} className="text-gray-600" />{" "}
