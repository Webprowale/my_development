...
const Illustrator = (props: Props) => {
  return (
    <div className="w-[55%] sticky top-0 h-screen bg-primary100 relative">
      <TranstitionChildren className="justify-center mt-20 text-center max-w-xl mx-auto text-primary600">
        <Motion>{""}</Motion>
        <Motion>
