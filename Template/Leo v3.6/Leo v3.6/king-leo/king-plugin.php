...
qa_register_plugin_module('page', 'king-leo.php', 'king_leo', 'kingleo');
qa_register_plugin_module('page', 'king-pricing.php', 'king_pricing', 'kingpricing');
qa_register_plugin_module('page', 'king-leo-ajax.php', 'submitai_ajax', 'kingAi ajax');
qa_register_plugin_module('page', 'king-favs.php', 'king_favs', 'kingfavs');
qa_register_plugin_module('page', 'king-pposts.php', 'king_pposts', 'kingpposts');
